...
user = api.model('User', {
    ...
    'signin' : fields.String(required=False, description=''),
    'secret' : fields.String(required=False, description=''),
    'wechat' : fields.String(required=False, description=''),
    'role_id' : fields.String(required=False, description=''),
    'role_name' : fields.String(required=False, description=''),
    ...
    'gender' : fields.String(required=False, description=''),
